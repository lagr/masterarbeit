...
\begin{document}
  ...
  \chapter{Prototypical Implementation} % (fold)
    ...
    Based on the considerations of the previos chapter, a Docker-based \ac{WfMS} prototype was implemented.
    ** etc**
  ...
  \begin{figure}[!htbp]
    ...
    \label{fig:the_whole_docker_compose_file_1}
  \end{figure}
  ...
  \begin{figure}[!htbp]
    ...
    \label{fig:the_whole_docker_compose_file_2}
  \end{figure}
  ...
  \begin{figure}[!htbp]
    ...
    \label{fig:the_whole_docker_compose_file_3}
  \end{figure}
  ...
  \begin{figure}[!htbp]
    ...
    \label{fig:the_whole_docker_compose_file_4}
  \end{figure}
  ...
  \begin{figure}[!htbp]
    ...
    \label{fig:the_whole_docker_compose_file_5}
  \end{figure}

  \AnhSection{Unterkapitel}

\AbschlErklaerung{03-08-2016}
\end{document}
