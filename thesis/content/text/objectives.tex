...
%   The requirements developed in \ref{sub:functional_requirements} can be concretized into objectives for the creation of the prototypical \ac{WfMS}.

%   \begin{description}
%     \item[Add enactment machines at runtime]
%     \item[Automatically configure added enactment machines]
%     \item[List enactment machines]
%     \item[Provide functionality under failure]
%     \item[Restart failing components]
%     \item[Define services required by workflows]
%   \end{description}
