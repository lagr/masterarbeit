...
\label{sub:components}
  ...
  \subsubsection{Workflow Modeling Service} % (fold)
    \label{ssub:workflow_modeling_service}
    % subsubsection workflow_modeling_service (end)

  \subsubsection{Environment Management Service} % (fold)
  ...
  \subsubsection{Developer Interface} % (fold)
    \label{ssub:developer_interface}
    % subsubsection developer_interface (end)
